...
namespace basecross {
	...
	void ResultScene::OnCreate() {
		try {
			...
			AddGameObject<ResultSceneSprite>(L"Result1", Vec2(1280.0f, 800.0f), Vec2(0.0f, 0.0f));
			AddGameObject<ResultSceneSprite>(L"UI_Time_2", Vec2(256.0f, 128.0f), Vec2(0.0f, 150.0f));
			AddGameObject<ResultSceneSprite>(L"Result", Vec2(256.0f, 128.0f), Vec2(0.0f, 300.0f));
			m_SpVec[0] = AddGameObject<ResultSceneSprite>(L"ritorai", Vec2(160.0f, 100.0f), Vec2(-150.0f, -250.0f));
			m_SpVec[1] = AddGameObject<ResultSceneSprite>(L"title", Vec2(160.0f, 100.0f), Vec2(150.0f, -250.0f));
